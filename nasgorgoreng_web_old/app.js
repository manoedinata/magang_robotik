...
class BaseStation {
  constructor() {
    ...
    this.log(
      "NasgorGoreng Base Station - Initialized. Ready to connect.",
      "info"
    );

    this.showNotification("Base Station Initialized.");
  }
  ...
  connectROS(url) {
    ...
    try {
      ...
      this.ros.on("connection", () => {
        this.connected = true;
        this.updateConnectionStatus(true);
        this.log("ROS bridge connected.", "success");
  ...
  subscribeToROSTopics() {
    ...
    this.showNotification("ROS2 connection established.");
  }
  ...
  disconnect() {
    ...
    this.showNotification("ROS2 connection disconnected.", "error");
  }
